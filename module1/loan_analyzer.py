...
print(f"Fair Value {present_value:.2f}")
...
# YOUR CODE HERE!
def calculatePresentValue(future_value, remaining_months, annual_discount_rate) :
...
# YOUR CODE HERE!
present_value = calculatePresentValue(loan.get('future_value'), loan.get('remaining_months'), 0.2)
